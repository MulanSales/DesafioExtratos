        ...
        const tableRows = `
            <table class="stress__table">
                ...
                <tr>
                    ...
                    <th>${Math.round(aggregate.latency.min/1000)} s</th>
                    <th>${Math.round(aggregate.latency.median/1000)} s</th>
                    <th>${Math.round(aggregate.latency.max/1000)} s</th>
                    <th>${aggregate.codes["200"]}</th>
                    <th>${Math.floor(100*(aggregate.scenariosCreated/aggregate.scenariosCompleted))}%</th>
                </tr>
            </table>
        `;
